...
async def _create_active_recurring_goal(
    client, token, recurrence="daily", deadline_delta_days=1
):
    ...
    resp = await client.post(
        ...
        json={
            ...
            "criteria": {
                ...
                "video_description": "Test content",
            },
    ...
    async with make_client() as client:
        ...
        resp = await client.post(
            ...
            json={
                ...
                "criteria": {
                    "min_duration_seconds": 300,
                    "video_description": "Monthly test",
                },
                "charity_id": "acct_charity_connect_123",
                "recurrence": "monthly",
            },
        ...
        await _backdate_deadline(
            goal_id, datetime.now(timezone.utc) - timedelta(days=30)
        )
...
async def test_non_recurring_goal_does_not_create_new_instance():
    ...
    async with make_client() as client:
        ...
        await _backdate_deadline(
            goal_id, datetime.now(timezone.utc) - timedelta(days=1)
        )
...
async def test_recurring_goal_pending_review_past_grace_creates_new_instance():
    ...
    async with make_client() as client:
        ...
        await _backdate_deadline(
            goal_id, datetime.now(timezone.utc) - timedelta(minutes=10)
        )
